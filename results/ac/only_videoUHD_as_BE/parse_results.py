...
for file_name in onlyfiles:
        ...
        for line in csv_reader:
            ...
            if "1000" in line[2]:
                try:
                    ...
                    bk_thr_list.append(0)
                    bk_delay_list.append(0)
                    bk_jitter_list.append(0)
                    bk_tx_packet_list.append(0)
                    bk_lost_list.append(0)
            elif "1005" in line[2]:
                try:
                    sta_count += 1
                    ...
                    pprint("No date to parse")
                    vi_thr_list.append(0)
                    vi_delay_list.append(0)
                    vi_jitter_list.append(0)
                    vi_tx_packet_list.append(0)
                    vi_lost_list.append(0)
            else:
    ...
    vi_dict["lost_percentage"] = sum(vi_lost_list) / sum(vi_tx_packet_list) if sum(vi_tx_packet_list) != 0 else 0
